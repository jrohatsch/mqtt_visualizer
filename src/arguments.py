...
parser.add_argument('-p',dest='port',help='The port to which the mqtt_visualizer should connect', type=int)
parser.add_argument('-t',dest='topic', help='the mqtt topic which should be observed', type=str)
parser.add_argument('--docker',dest='docker', help='boolean flag wether the app run through docker', type=bool)
